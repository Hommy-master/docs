...
## 🌐 Language Switch
[中文版](/docs/video_infos.zh) | [English](/docs/video_infos)
...
| transition | string |❌ | None | Transition name; see [add_videos](/docs/add_videos) |
...
For the full list of valid `transition` values, see [add_videos](/docs/add_videos) → Supported Transition Names. For intro/outro/loop clip animations, see [add_images](/docs/add_images).
