...
| in_animation | string |❌ | None |入场动画名称，可用值见 [add_images](/docs/add_images.zh) |
| in_animation_duration | number |❌ | 500000 |入时长(微秒) |
| loop_animation | string |❌ | None |循环动画名称，可用值见 [add_images](/docs/add_images.zh) |
| loop_animation_duration | number |❌ | 1000000 |循动画时长(微秒) |
| out_animation | string |❌ | None |出场动画名称，可用值见 [add_images](/docs/add_images.zh) |
| out_animation_duration | number |❌ | 500000 |出动画时长(微秒) |
| transition | string |❌ | None |转场名称，可用值见 [add_images](/docs/add_images.zh) / [add_videos](/docs/add_videos.zh) |
| transition_duration | number |❌ | 300000 |转场时长(微秒) |

### 可用转场与动画名称

转场、入场/出场/循环动画的完整可用值清单，请参见 [添加图片（add_images）](/docs/add_images.zh) 文档中的「支持的转场与动画名称」。
...
- [创建草稿](/docs/create_draft)
- [添加图片](/docs/add_images)
- [时间线](/docs/timelines)
- [保存草稿](/docs/save_draft)
