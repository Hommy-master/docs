---
description: Batch-add audios. audio_infos is a JSON string; times are microseconds.
---

# ADD_AUDIOS API Documentation

## 🌐 Language Switch
[中文版](/docs/add_audios.zh) | [English](/docs/add_audios)
...
Pass draft_url from create_draft. audio_infos must be a JSON string, not an object array. start/end are microseconds.
