---
description: Batch-add captions. captions is a JSON string; times are microseconds.
---

# ADD_CAPTIONS API Documentation

## 🌐 Language Switch
[中文版](/docs/add_captions.zh) | [English](/docs/add_captions)
...
Pass draft_url from create_draft. captions must be a JSON string, not an object array. start/end are microseconds.
...
- [Caption Infos](/docs/caption_infos)
- [Get Text Animations](/docs/get_text_animations)
- [Get Text Effects](/docs/get_text_effects)
