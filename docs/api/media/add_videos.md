---
description: Batch-add videos. video_infos is a JSON string; times are microseconds.
---

# ADD_VIDEOS API Documentation

## 🌐 Language Switch
[中文版](/docs/add_videos.zh) | [English](/docs/add_videos)
...
Pass draft_url from create_draft. video_infos must be a JSON string, not an object array. start/end/duration are microseconds.
