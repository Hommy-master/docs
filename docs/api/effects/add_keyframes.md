...
## 🌐 Language Switch
[中文版](/docs/add_keyframes.zh) | [English](/docs/add_keyframes)
...
Mask keyframes are not handled by this API; use [Add Mask Keyframes](/docs/add_mask_keyframes) instead.
...
7. **Mask properties**: Use [Add Mask Keyframes](/docs/add_mask_keyframes) for mask position/size/feather/rotation.
8. **Helper API**: [Keyframes Infos](/docs/keyframes_infos) can generate a compatible `keyframes` JSON string.
...
- [Keyframes Infos](/docs/keyframes_infos)
- [Add Mask Keyframes](/docs/add_mask_keyframes)
