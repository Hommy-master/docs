...
## 🌐 Language Switch
[中文版](/docs/add_mask_keyframes.zh) | [English](/docs/add_mask_keyframes)
...
- Call [Add Masks](/docs/add_masks) before adding mask keyframes.
...
- [Add Masks](/docs/add_masks)
- [Add Keyframes](/docs/add_keyframes)
