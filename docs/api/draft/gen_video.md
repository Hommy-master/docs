---
description: Submit an async video export job. This is the only billed endpoint; hosted calls need apiKey.
---

# GEN_VIDEO API Documentation

## 🌐 Language Switch
[中文版](/docs/gen_video.zh) | [English](/docs/gen_video)
...
This endpoint only submits the job. Poll gen_video_status until status=completed or failed. Hosted export requires a UUID apiKey.
...
- **draft_url**: Complete URL address of the draft
  ...
  - Acquisition Method: Obtained via [Create Draft](/docs/create_draft) or [Save Draft](/docs/save_draft) interfaces
...
- [Add Audios](/docs/add_audios)
- [Add Images](/docs/add_images)
- [Get Draft](/docs/get_draft)
- [Query Video Generation Status](/docs/gen_video_status)
