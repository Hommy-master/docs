---
description: Create a Jianying draft and return the draft_url required by later write APIs.
---

# CREATE_DRAFT API Documentation

## 🌐 Language Switch
[中文版](/docs/create_draft.zh) | [English](/docs/create_draft)
...
Time unit is microseconds (1s=1000000). Pass the returned draft_url unchanged to every later write call. Do not invent a draft_id.
